...
- [phalcon/phql](https://github.com/phalcon/phql) - Phalcon Query Language (PHQL). (today)
...
- [zephir-lang/php-zephir-parser](https://github.com/zephir-lang/php-zephir-parser) ([v2.0.4](https://github.com/zephir-lang/php-zephir-parser/releases/tag/v2.0.4), 3 days ago) - The Zephir Parser delivered as a C extension for the PHP language.
