...
- [phalcon/incubator-acl](https://github.com/phalcon/incubator-acl) - Extra components for Acl (3 weeks ago)
...
- [ampproject/amphtml](https://github.com/ampproject/amphtml) ([2306121857000](https://github.com/ampproject/amphtml/releases/tag/2306121857000), 1 day ago) - The AMP web component framework.
- [phalcon/cphalcon](https://github.com/phalcon/cphalcon) ([v5.2.2](https://github.com/phalcon/cphalcon/releases/tag/v5.2.2), 3 days ago) - High performance, full-stack PHP framework delivered as a C extension.
- [phalcon/incubator-acl](https://github.com/phalcon/incubator-acl) ([v1.0.1](https://github.com/phalcon/incubator-acl/releases/tag/v1.0.1), 3 weeks ago) - Extra components for Acl
- [phalcon/incubator-validation](https://github.com/phalcon/incubator-validation) ([v2.1.0](https://github.com/phalcon/incubator-validation/releases/tag/v2.1.0), 3 weeks ago) - Extra Phalcon Validator Adapters. 
- [RubixML/ML](https://github.com/RubixML/ML) ([2.4.0](https://github.com/RubixML/ML/releases/tag/2.4.0), 3 weeks ago) - A high-level machine learning and deep learning library for the PHP language.
...
- [phalcon/bridge-swoole](https://github.com/phalcon/bridge-swoole) ([v1.0.0](https://github.com/phalcon/bridge-swoole/releases/tag/v1.0.0), 3 months ago) - Bridge to run Phalcon with Swoole.
