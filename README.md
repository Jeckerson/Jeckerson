...
- [phalcon/annotations](https://github.com/phalcon/annotations) - Annotations parser library (4 days ago)
- [phalcon/debugbar](https://github.com/phalcon/debugbar) -  (6 days ago)
- [phalcon/bridge-psr11](https://github.com/phalcon/bridge-psr11) - Bridge PSR-11 connects the Phalcon Container and the PSR-11 standard in both directions (6 days ago)
...
- [phalcon/cphalcon](https://github.com/phalcon/cphalcon) ([v5.21.0](https://github.com/phalcon/cphalcon/releases/tag/v5.21.0), 2 days ago) - High performance, full-stack PHP framework delivered as a C extension.
- [phalcon/phalcon](https://github.com/phalcon/phalcon) ([v6.0.0RC1](https://github.com/phalcon/phalcon/releases/tag/v6.0.0RC1), 2 days ago) - Phalcon Framework as a PHP implementation
- [zephir-lang/zephir](https://github.com/zephir-lang/zephir) ([1.5.0](https://github.com/zephir-lang/zephir/releases/tag/1.5.0), 2 days ago) - Zephir is a compiled high-level language aimed to ease the creation of C-extensions for PHP
