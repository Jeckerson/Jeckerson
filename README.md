...
- [zephir-lang/zephir](https://github.com/zephir-lang/zephir) ([0.22.0](https://github.com/zephir-lang/zephir/releases/tag/0.22.0), 3 days ago) - Zephir is a compiled high-level language aimed to ease the creation of C-extensions for PHP
- [zephir-lang/php-zephir-parser](https://github.com/zephir-lang/php-zephir-parser) ([v2.0.2](https://github.com/zephir-lang/php-zephir-parser/releases/tag/v2.0.2), 4 days ago) - The Zephir Parser delivered as a C extension for the PHP language.
