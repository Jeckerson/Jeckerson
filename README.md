...
- [phalcon/incubator-session](https://github.com/phalcon/incubator-session) ([v3.0.0](https://github.com/phalcon/incubator-session/releases/tag/v3.0.0), 3 months ago) - Extra Phalcon Session Adapters.
- [zephir-lang/php-zephir-parser](https://github.com/zephir-lang/php-zephir-parser) ([v1.8.0](https://github.com/zephir-lang/php-zephir-parser/releases/tag/v1.8.0), 4 months ago) - The Zephir Parser delivered as a C extension for the PHP language.
...
- [zephir-lang/zephir](https://github.com/zephir-lang/zephir) ([0.19.0](https://github.com/zephir-lang/zephir/releases/tag/0.19.0), 9 months ago) - Zephir is a compiled high-level language aimed to ease the creation of C-extensions for PHP
