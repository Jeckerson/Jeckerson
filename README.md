...
- [phalcon/cphalcon](https://github.com/phalcon/cphalcon) ([v5.14.1](https://github.com/phalcon/cphalcon/releases/tag/v5.14.1), 4 days ago) - High performance, full-stack PHP framework delivered as a C extension.
- [zephir-lang/zephir](https://github.com/zephir-lang/zephir) ([0.23.0](https://github.com/zephir-lang/zephir/releases/tag/0.23.0), 6 days ago) - Zephir is a compiled high-level language aimed to ease the creation of C-extensions for PHP
- [zephir-lang/php-zephir-parser](https://github.com/zephir-lang/php-zephir-parser) ([v2.0.4](https://github.com/zephir-lang/php-zephir-parser/releases/tag/v2.0.4), 1 week ago) - The Zephir Parser delivered as a C extension for the PHP language.
