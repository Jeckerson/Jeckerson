...
- [phalcon/cphalcon](https://github.com/phalcon/cphalcon) ([v5.22.0](https://github.com/phalcon/cphalcon/releases/tag/v5.22.0), 1 day ago) - High performance, full-stack PHP framework delivered as a C extension.
- [phalcon/phalcon](https://github.com/phalcon/phalcon) ([v6.0.0RC2](https://github.com/phalcon/phalcon/releases/tag/v6.0.0RC2), 1 day ago) - Phalcon Framework as a PHP implementation
- [zephir-lang/zephir](https://github.com/zephir-lang/zephir) ([1.5.0](https://github.com/zephir-lang/zephir/releases/tag/1.5.0), 5 days ago) - Zephir is a compiled high-level language aimed to ease the creation of C-extensions for PHP
